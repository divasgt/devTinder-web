...
function getSocialIcon(title) {
  ...
  return SOCIAL_ICONS[t] || IconExternal;
}

function UserProfileSidebar({ user, connectionStatus = null, isSelf = false }) {
  const {
    firstName,
    lastName,
    photoUrl,
  ...
  return (
    <div className="card p-0 overflow-hidden">
      ...
      <div className="p-6 space-y-4">
        ...
        {isSelf ? (
          <Link to="/profile/edit" className="btn-primary w-full flex items-center justify-center">
            Edit Profile
          </Link>
